...
class SettingsFragment : BaseSettingsFragment() {
    ...
    private var deviceSettings: Preference? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        deviceSettings = findPreference("button_key_device")
        ...
        deviceSettings!!.onPreferenceClickListener = Preference.OnPreferenceClickListener { preference ->
            view.let { Navigation.findNavController(it).navigate(R.id.device_action) }
            false
        }
